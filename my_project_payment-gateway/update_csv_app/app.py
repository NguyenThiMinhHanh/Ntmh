...
app = Flask(__name__)
app.config['UPLOAD_FOLDER'] = r'D:\tt\my_project_payment-gateway\my_project_payment-gateway\static\uploads'
app.config['CSV_FILE'] = r'D:\tt\my_project_payment-gateway\my_project_payment-gateway\data\analysis.csv'
